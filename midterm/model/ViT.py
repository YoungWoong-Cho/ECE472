...
def vit_small_patch8_32(pretrained=False, **kwargs):
    """ ViT-Small (ViT-S/8) at 32x32.
    """
    model_kwargs = dict(img_size=32, patch_size=8, embed_dim=384, depth=12, num_heads=6, **kwargs)
    # model = _create_vision_transformer('vit_small_patch8_32', pretrained=pretrained, **model_kwargs)
