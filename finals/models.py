...
class MuZeroNetwork:
    def __new__(cls, config):
        ...
        elif config.network == "new":
            return MuZeroNewNetwork(
                config.observation_shape,
                config.stacked_observations,
                len(config.action_space),
                config.blocks,
...
class MuZeroResnetNetwork(AbstractNetwork):
    def __init__(
        self,
        observation_shape,
        stacked_observations,
...
class RepresentationNewNetwork(torch.nn.Module):
    def __init__(
        self,
        observation_shape,
        stacked_observations,
...
class MuZeroNewNetwork(AbstractNetwork):
    def __init__(
        self,
        observation_shape,
        stacked_observations,
        ...
        self.representation_network = RepresentationNewNetwork(
                observation_shape,
                stacked_observations,
                num_blocks,
                num_channels,
